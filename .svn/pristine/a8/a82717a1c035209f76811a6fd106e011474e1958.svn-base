package com.goddess.ec.manage.listener;
 ...
 * 系统启动初始化数据
 * 
 * @author dongyihao 2014年9月27日 下午11:07:53
 */
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		if (file != null) {
			try {
				...
				log.info("初始化log4j日志输入路径异常，请检查web.xml参数配置是否正常，异常发生在" + this.getClass().getName()
				        + "类的public void init()方法，异常的原因是：" + e.getMessage(), e.fillInStackTrace());
			}
		}
	}
