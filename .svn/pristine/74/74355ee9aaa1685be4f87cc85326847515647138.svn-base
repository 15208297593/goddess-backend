...
public class ToolDateTime {
	...
	public static final String pattern_ymd_hms_s_str = "yyyyMMddHHmmssSSS";
	...
	public static Timestamp getNow() {
	    return getSqlTimestamp(getDateByTime());
	}

	public static String getNowStr() {
		return format(getSqlTimestamp(getDateByTime()), pattern_ymd_hms_s_str);
	}
	 ...
	 * @return
	 */
	public static Date startDateByDay(String start, String pattern, int end) {
		return startDateByDay(parse(start, pattern), end);
	}
	 ...
	 * @return
	 */
	public static Date endDateByDay(String start, String pattern) {
		return endDateByDay(parse(start, pattern));
	}
	...
	public static void main(String[] args) throws ParseException {
		...
		// System.out.println(format(end, pattern_ymdtime));
		 ...
		 Date startDate = ToolDateTime.startDateByDay(endDate, 0);
		 System.out.println(format(startDate, pattern_ymd_hms));
		 System.out.println(format(endDate, pattern_ymd_hms));
