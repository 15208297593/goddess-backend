$(function () {
    ...
    $.fn.datetimebox.defaults.formatter = function(date){
        ...
        var h = formatHMS(date.getHours()); //小时
        var min = formatHMS(date.getMinutes()); //分
        var s = formatHMS(date.getSeconds()); //秒
    ...
    $.extend($.fn.validatebox.defaults.rules, {
    	...
    	dateGreat: {
            validator: function(value,param){
            	var date_to = $(param[0]).datebox("getValue");
                return !date_to || value >= date_to;
            },
            message: '结束日期应比开始日期晚！'
    	},
    	dateLess: {
            validator: function(value,param){
            	var date_from = $(param[0]).datebox("getValue");
                return !date_from || value <= date_from;
            },
            message: '开始日期应比结束日期早！'
    	},
    	json: {
...
function formatHMS(hms) {
    return ("00"+ hms).substr((""+ hms).length);
}