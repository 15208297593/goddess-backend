package com.goddess.ec.manage.handler;
...
/**
 * 全局Handler，设置一些通用功能<br/>
 * 主要是一些全局变量的设置，再就是日志记录开始和结束操作
 */
...
//		request.setAttribute(reqSysLogKey, reqSysLog);
		...
		log.info("设置图片访问URL");
		request.setAttribute("imageUrl", PropertiesPlugin.getParamMapValue(DictKeys.image_url));
